// API URLs for Multiple information resources
// Major thanks to Jpg.store

const jpgStore = 'https://www.jpg.store/collection/';
...
const ipfsBase = 'https://ipfs.blockfrost.dev/ipfs/';
